...
formFeedbackPopup && formFeedbackPopup.addEventListener("submit", function (evt) {
...
buttonFeedback && buttonFeedback.addEventListener("click", function (evt) {
  evt.preventDefault();
  formFeedbackPopup.classList.add("active");
  feedbackName.focus();
});

buttonClose && buttonClose.addEventListener("click", function (evt) {
  evt.preventDefault();
...
var titlSlideFirst = document.querySelector("#title-slide-first");
var titlSlideSecond = document.querySelector("#title-slide-second");
var titlSlideThird = document.querySelector("#title-slide-third");

buttonSlideFirst && buttonSlideFirst.addEventListener("click", function (evt) {
  evt.preventDefault();
  ...
  titlSlideSecond.classList.remove("active");
  titlSlideThird.classList.remove("active");

  titlSlideFirst.classList.add("active");
  buttonSlideFirst.classList.add("current");
  mainBackground.classList.add("main-slide-first");
});

buttonSlideSecond && buttonSlideSecond.addEventListener("click", function (evt) {
  evt.preventDefault();
  var currentButton = document.querySelector(".current");
  currentButton.classList.remove("current");
  ...
  titlSlideFirst.classList.remove("active");
  titlSlideThird.classList.remove("active");

  titlSlideSecond.classList.add("active");
  buttonSlideSecond.classList.add("current");
  mainBackground.classList.add("main-slide-second");
});

buttonSlideThird && buttonSlideThird.addEventListener("click", function (evt) {
  evt.preventDefault();
  var currentButton = document.querySelector(".current");
  currentButton.classList.remove("current");
  ...
  titlSlideThird.classList.add("active");
...
loginForm && loginForm.addEventListener("submit", function (evt) {
  ...
  setTimeout(()=>{loginForm.classList.remove("modal-error");}, 600)
});
...
subscriptionForm && subscriptionForm.addEventListener("submit", function (evt) {
